...
class ProfileTests(APITestCase):
    def setUp(self):
        self.business_user = User.objects.create_user(username='business1', email='biz@example.com', password='testpass')
        self.customer_user = User.objects.create_user(username='customer1', email='cust@example.com', password='testpass')
        self.business_profile = UserProfile.objects.create(user=self.business_user, username='business1', type='business')
        self.customer_profile = UserProfile.objects.create(user=self.customer_user, username='customer1', type='customer')

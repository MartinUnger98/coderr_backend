...
class UploadTests(APITestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='uploaduser', password='uploadpass')
        self.profile = UserProfile.objects.create(user=self.user, username='uploaduser', type='customer')
